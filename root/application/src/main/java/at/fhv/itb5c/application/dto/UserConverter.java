...
public class UserConverter implements ILogger {
	public static IUser toDTO(User user){
		...
		try {
			...
			userdto.setDepartment(DepartmentConverter.toDTO(user.getDepartment(), userdto));
		} catch (Exception e) {
	...
	public static IUser toDTO(User user, IDepartment iDepartment){
		// null in - null out
		if(user==null){
			return null;
		}
		...
		userdto.setTypeOfSports(user.getTypeOfSports());
		userdto.setMembershipFeePaid(user.getMembershipFeePaid());
		userdto.setDepartment(iDepartment);
	...
	public static User toEntity(IUser userdto){
		...
		try {
			...
			user.setDepartment(DepartmentConverter.toEntity(userdto.getDepartment(), user));
		} catch (Exception e) {
			log.error(e.getMessage());
			return null;
		} 
	...
	public static User toEntity(IUser userdto, Department department){
		// null in - null out
		if(userdto==null){
			return null;
		}
