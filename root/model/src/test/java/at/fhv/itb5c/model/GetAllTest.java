...
public class GetAllTest {
	...
	public void getAllDepartments() {
		List<Department> depts = (List<Department>) PersistenceFacade.getInstance()
	...
	public void getAllObjects() {
		List<PersistableObject> users = (List<PersistableObject>) PersistenceFacade.getInstance()
				.<PersistableObject> getAll(PersistableObject.class);
